...
@Database(entities = {UserDBModel.class, FeedDBModel.class, PhotoAttachmentsModel.class, AudioAttachmentsModel.class, LinkAttachmentsModel.class, VideoAttachmentsModel.class, PostSourceModel.class}, version = 1)
public abstract class AppDatabase extends RoomDatabase {
    public abstract UserDAO userDAO();
    public abstract FeedDAO feedDAO();
    public abstract PostSourceDAO postSourceDAO();
